...
\paragraph{Calculation of $\Delta\phi$}
...
They are defined as a "constant" in \texttt{gtl_luts_pkg.vhd} VHDL package file.
The values of precision and step size are given by "scale_set" in XML file of a L1 menu.

\textbf{LUTs for \pt and unconstrained \pt used in mass cuts}

The values of \pt or unconstrained \pt LUT are calculated by building the difference of maximum and minimum value of a bin, rounding at precision position after decimal point and multiplying with $10^precision$ to get integer values.\\
...
All precision names for "MassPt":
EG-EG-MassPt
EG-JET-MassPt
EG-TAU-MassPt
JET-JET-MassPt
...
\textbf{LUTs for $\cosh($$\Delta\eta$$)$ used in mass cuts}
...
\textbf{LUTs for $\cos($$\Delta\phi$$)$ used in mass cuts}
...
\textbf{LUTs for 1/$\Delta$$R^2$ used in mass over deltaR cuts}
...
All precision names for "InverseDeltaRMath":
...
\textbf{LUTs for $\cos($$\varphi$$)$ used in two-body pt cuts}
