...
gt_parts = ['GT', 'FRAME', 'GTL_FW', 'FDL_FW']
...
gt_parts[3]: {version_parts[0]: 0, version_parts[1]: 0, version_parts[2]: 0}
}
...
gt_version = "v{}.{}.{}".format(versions["GT"]["MAJOR"],versions["GT"]["MINOR"],versions["GT"]["REV"])
