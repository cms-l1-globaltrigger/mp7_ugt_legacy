...
Links 0..3 contain muon data from uGMT, links 4..10 data from Calo-Layer2, link 11 is reserved for ZDC data and links 12..15 external conditions
from AMC502 boards. On link 16 CICADA data are received from Calo-Layer1.
...
\begin{table}[ht]
\caption{\bf Overview optical input links (part 1)}
\vspace{5mm}
\scalebox{0.8}{
\centering
...
\begin{table}[ht]
\caption{\bf Overview optical input links (part 2)}
\vspace{5mm}
\scalebox{0.8}{
\centering
\begin{tabular}{|c|c|c|c|c|c|c|p{4.0cm}|}\hline
 & \multicolumn{7}{ c| }{link} \\\hline
frame & 10 & 11 & 12 & 13 & 14 & 15 &\makebox[4.0cm][c]{16} \\\hline\hline
...
4 & ET$_{miss}^{HF}$ & res & free & free & free & free &  BJET4,\\
 & ASYMETHF, & (ZDC) & & & & & Heavy Ion -\\
 & CENT[3:0] & & & & & & high \\
5 & HT$_{miss}^{HF}$ & res & free & free & free & free & BJET5,\\
 & ASYMHTHF, & (ZDC) & & & & & Heavy Ion -\\
 & CENT[7:4] & & & & & & low \\\hline
\end{tabular}
}
