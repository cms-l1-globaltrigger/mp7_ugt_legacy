...
\label{sec:gtl:adt}
The possibility of implementing "Anomaly Detection Trigger" (ADT) is forseen in this version of \ugtl. The VHDL code is given by "Anomaly Detection Trigger" group in directory 
