...
\begin{bytefield}[boxformatting={\centering\itshape}, bitwidth=1.2em, endianness=big]{32}
        ...
        \bitbox {28}     {\texttt{bjet 1}} \\
\end{bytefield}
\begin{bytefield}[boxformatting={\centering\itshape}, bitwidth=1.2em, endianness=big]{32}
        \bitheader{0,27,28,31} \\
        \bitbox {4}      {\texttt{AD I h}} &
        \bitbox {28}     {\texttt{bjet 2}} \\
\end{bytefield}
\begin{bytefield}[boxformatting={\centering\itshape}, bitwidth=1.2em, endianness=big]{32}
        \bitheader{0,27,28,31} \\
        \bitbox {4}      {\texttt{AD D l}} &
        \bitbox {28}     {\texttt{bjet 3}} \\
\end{bytefield}
\begin{bytefield}[boxformatting={\centering\itshape}, bitwidth=1.2em, endianness=big]{32}
        \bitheader{0,27,28,31} \\
        \bitbox {4}      {\texttt{AD D h}} &
        \bitbox {28}     {\texttt{bjet 4}} \\
\end{bytefield}
\begin{bytefield}[boxformatting={\centering\itshape}, bitwidth=1.2em, endianness=big]{32}
        \bitheader{0,27,28,31} \\
        \bitbox {4}      {\texttt{HI low}} &
        \bitbox {28}     {\texttt{bjet 5}} \\
\end{bytefield}
\begin{bytefield}[boxformatting={\centering\itshape}, bitwidth=1.2em, endianness=big]{32}
        \bitheader{0,27,28,31} \\
        \bitbox {4}      {\texttt{HI high}} &
        \bitbox {28}     {\texttt{bjet 6}} \\
\end{bytefield}
\end{center}
