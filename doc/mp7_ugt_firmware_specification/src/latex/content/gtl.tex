...
\item Muon shower bits (bit 61 on MU0, MU2, MU3, MU4, MU4)
\end{itemize}
...
See also \ref{sec:gtl:optical_interfaces}.\\
\textbf{\Esums}:\\ Consists of following quantities (for naming convention see "Glossary" \ref{sec:glossary}):
\begin{itemize}
\item \textbf{\ett}
\item \textbf{\htt}
\item \textbf{\etm}
...
Muon shower bits MUS0 (MUon Shower, bit 61 on MU0), MUS1 (bit 61 on MU2), MUS2 (bit 61 on MU3), MUSOOT0 (MUon Shower Out Of Time, bit 61 on MU4), MUSOOT1 (bit 61 on MU6) can be selected by TME to an algo or combined with other conditions to an algo.
