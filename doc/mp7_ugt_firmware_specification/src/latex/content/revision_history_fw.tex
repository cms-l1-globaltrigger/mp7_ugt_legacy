...
\hline
\endhead
7.5 & Inserted "Appendix E" (\ref{sec:app:app_e}). & 2022/03/24\\
...
7.3 & Added Global Trigger input and output links description to "Appendices" (\ref{sec:app:app_c}). & 2022/02/28\\
