...
\hline
\endhead
8.7 & Cleaned up text and layout. & 2022/12/13\\
8.6 & Added chapter "Handling of timing errors in synthesis" (\ref{sec:app:synth_timing_errors}). & 2022/12/01\\
8.5 & Cleaned up (used "textquotesingle"). & 2022/11/30\\
8.4 & Updated "Configuration of GTHs" (\ref{sec:app:gth_conf_table}). & 2022/11/24\\
8.3 & Inserted chapter "ZDC 5G to 10G conversion scheme" to "Appendices" (\ref{sec:app:zdc_5g_10g_conv}). Replaced picture with Table in "Configuration of GTHs" (\ref{sec:app:app_a}). & 2022/10/14\\
8.2 & Inserted chapter "GTH I/Os" to "Appendices" (\ref{sec:app:gth_io}). & 2022/10/14\\
