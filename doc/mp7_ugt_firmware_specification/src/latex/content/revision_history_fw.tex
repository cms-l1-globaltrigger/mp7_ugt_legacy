...
\hline
\endhead
2.33 & Added description of readout record to bibliography, updated chapter "Readout process" (\ref{sec:rop:rop}) and chapter "Configuration of optical input links" (\ref{sec:app:app_b}). & 2023/07/04\\
