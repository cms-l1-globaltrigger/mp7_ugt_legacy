...
\hline
\endhead
2.30 & Updated chapter "Muon shower bits" (\ref{sec:gtl:muon_shower_bits}). Inserted chapter "Anomaly Detection trigger" (\ref{sec:gtl:adt}). Updated "Appendices" (\ref{sec:app:app}). & 2023/03/06\\
