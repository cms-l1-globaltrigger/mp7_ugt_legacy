...
\hline
\endhead
2.35 & Added tables \ref{tab:app:gth_i_conn}, \ref{tab:app:gth_o_conn}, \ref{table:app:sum_opt_links} and \ref{table:app:sum_opt_links2}, removed figure "Optical link inputs to Global Trigger". Removed chapter "GTH I/Os" from "Appendices" & 2023/02/16\\
2.34 & Updated text in "Definitions of CICADA data" (\ref{sec:gtl:def_cicada}) and in "Appendices" (\ref{sec:app:app}). & 2023/02/08\\
2.33 & Added chapter "Calo-Layer1 optical interface" (\ref{sec:gtl:calo1_optical_interfaces}). & 2023/02/07\\
