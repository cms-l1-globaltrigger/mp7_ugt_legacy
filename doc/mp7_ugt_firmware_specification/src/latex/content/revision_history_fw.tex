...
\hline
\endhead
6.8 & Updated text of sections "Implementation in firmware" for Framework (\ref{sec:frame:implementation_firmware}), GTL (\ref{sec:gtl:implementation_firmware_gtl}) and FDL (\ref{sec:fdl:implementation_firmware}). & 2022/02/10\\
6.7 & Inserted references and updated text in \ref{dir_struct_gt_fw}. & 2022/02/09\\
