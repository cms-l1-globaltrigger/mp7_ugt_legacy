...
\hline
\endhead
2.31 & Fixed value of $\eta$ range in \ref{sec:gtl:calorimeter_data}. & 2023/02/20\\
2.30 & Added tables \ref{tab:app:gth_i_conn}, \ref{tab:app:gth_o_conn}, \ref{table:app:sum_opt_links} and \ref{table:app:sum_opt_links2}, removed figure "Optical link inputs to Global Trigger". Removed chapter "GTH I/Os" from "Appendices" & 2023/02/16\\
