...
\hline
\endhead
2.50 & Added chapters for ZDC description \ref{sec:gtl:ugtl_interface}, \ref{sec:gtl:zdc_optical_interfaces} and \ref{sec:gtl:def_zdc}. Updated chapter \ref{sec:app:ext_cond_pp}. & 2024/10/14\\
2.49 & Updated chapters "Prescaler logic" (\ref{sec:fdl:prescaler_logic}). & 2024/10/08\\
2.48 & Fixed typo in table (\ref{tab:app:gth_conf}) and updated chapter (\ref{sec:app:zdc_5g_scheme}). & 2024/09/30\\
2.47 & Added chapter "Preventing timing errors by fixing cells in Vivado" (\ref{sec:app:prevent_timing_errors}). & 2024/09/23\\
