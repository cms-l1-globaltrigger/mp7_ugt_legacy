...
\hline
\endhead
8.8 & Cleaned up text and layout. & 2022/12/13\\
8.7 & Added chapter "Handling of timing errors in synthesis" (\ref{sec:app:synth_timing_errors}). & 2022/12/01\\
8.6 & Cleaned up (used "textquotesingle"). & 2022/11/30\\
8.5 & Updated "Configuration of GTHs" (\ref{sec:app:gth_conf_table}). & 2022/11/24\\
8.4 & Inserted chapter "GTH I/Os" to "Appendices" (\ref{sec:app:gth_io}). & 2022/10/12\\
8.3 & Added table "Firmware versions" (\ref{tab:fw:versions}). & 2022/09/27\\
8.2 & Updated "Appendices" (\ref{sec:app:app}). & 2022/09/26\\
8.1 & Updated text in "LUTs for 1/$\Delta$$R^2$" (\ref{sec:gtl:calc_luts_corr_cuts}), added new chapter "Muon shower bits" (\ref{sec:gtl:muon_shower_bits}). & 2022/09/13\\
8.0 & Updated text for \finor-mask and veto-mask (\ref{sec:fdl:finor_masks} and \ref{sec:fdl:veto_masks}). Updated \href{\gitbranch/tree/master/doc/mp7_ugt_firmware_specification/src/latex/content/versions.tex}{\texttt{versions.tex}}. & 2022/09/09\\
7.9 & Updated text for "fractional prescale", reset prescaler with "start" (\ref{sec:fdl:pre_scalers}). & 2022/08/17\\
7.8 & Updated text for "fractional prescale" values (\ref{sec:fdl:pre_scalers}). & 2022/07/11\\
7.7 & Inserted "Anomaly Detection Trigger" (\ref{sec:gtl:adt}). & 2022/05/27\\
7.6 & Added Global Trigger input and output links description to "Appendices" (\ref{sec:app:app}). & 2022/05/27\\
