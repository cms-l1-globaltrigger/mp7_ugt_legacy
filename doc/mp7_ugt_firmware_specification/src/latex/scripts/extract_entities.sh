...
vhdl_files=(
            ...
            "gt_mp7_core/gtl_fdl_wrapper/gtl/calo_conditions.vhd"
            "gt_mp7_core/gtl_fdl_wrapper/gtl/muon_conditions.vhd"
            "gt_mp7_core/gtl_fdl_wrapper/gtl/esums_conditions.vhd"
            "gt_mp7_core/gtl_fdl_wrapper/gtl/calo_calo_correlation_condition.vhd" "gt_mp7_core/gtl_fdl_wrapper/gtl/calo_muon_correlation_condition.vhd"
            "gt_mp7_core/gtl_fdl_wrapper/gtl/muon_muon_correlation_condition.vhd" "gt_mp7_core/gtl_fdl_wrapper/gtl/calo_esums_correlation_condition.vhd" 
            "gt_mp7_core/gtl_fdl_wrapper/gtl/muon_esums_correlation_condition.vhd" "gt_mp7_core/gtl_fdl_wrapper/gtl/gtl_module_tpl.vhd"
...
cd ~/github/cms-l1-globaltrigger/tm-vhdlproducer
git checkout new_muon_structure
cd -
cp ~/github/cms-l1-globaltrigger/tm-vhdlproducer/tmVhdlProducer/templates/vhdl/instances/calo_condition.vhd.j2 ../interfaces/instance_calo_condition.vhd.j2
cp ~/github/cms-l1-globaltrigger/tm-vhdlproducer/tmVhdlProducer/templates/vhdl/instances/muon_condition.vhd.j2 ../interfaces/instance_muon_condition.vhd.j2
cp ~/github/cms-l1-globaltrigger/tm-vhdlproducer/tmVhdlProducer/templates/vhdl/instances/esums_condition.vhd.j2 ../interfaces/instance_esums_condition.vhd.j2
cp ~/github/cms-l1-globaltrigger/tm-vhdlproducer/tmVhdlProducer/templates/vhdl/instances/calo_calo_correlation_condition.vhd.j2 ../interfaces/instance_calo_calo_correlation_condition.vhd.j2
cp ~/github/cms-l1-globaltrigger/tm-vhdlproducer/tmVhdlProducer/templates/vhdl/instances/calo_muon_correlation_condition.vhd.j2 ../interfaces/instance_calo_muon_correlation_condition.vhd.j2
cp ~/github/cms-l1-globaltrigger/tm-vhdlproducer/tmVhdlProducer/templates/vhdl/instances/muon_muon_correlation_condition.vhd.j2 ../interfaces/instance_muon_muon_correlation_condition.vhd.j2
cp ~/github/cms-l1-globaltrigger/tm-vhdlproducer/tmVhdlProducer/templates/vhdl/instances/calo_esums_correlation_condition.vhd.j2 ../interfaces/instance_calo_esums_correlation_condition.vhd.j2
cp ~/github/cms-l1-globaltrigger/tm-vhdlproducer/tmVhdlProducer/templates/vhdl/instances/muon_esums_correlation_condition.vhd.j2 ../interfaces/instance_muon_esums_correlation_condition.vhd.j2
