...
\textbf{Remark:}\\
This document contains a preliminary version of adding \textbf{ETT\_pos}, \textbf{ETT\_neg} and \textbf{minimum bias UPC} objects to the data structure of uGT inputs. Those objects are proposed by \textbf{Ivan Cali} in the document \textbf{"L1FWneedsPbPb2018run.docx"} in an email of 9th January 2025 (subject "Re: uGT available inputs for AXO").\\
ETT\_pos and ETT\_neg have 12 bits each and will be located on the 4 MSB of e/$\gamma$ objects 0..5. There will be 4 objects of minimum bias UPC with 4 bits each, located on the 4 MSB of e/$\gamma$ objects 6..9.\\
See Tables: \ref{table:scales_table_1}, \ref{table:sum_opt_links}, \ref{table:egamma_object} and \ref{table:bits_31_28_eg_object}.\\
=================================================================================
...
- "hadronic shower trigger (mus)" bits on bit 61 of MU0, MU2, MU3, MU4 and MU6 objects.
...
15) The "CICADA" data structure with values for Anomaly Detection and Heavy Ion bits~\cite{CICADA}.
...
Table~\ref{table:scales_table_4} shows the bits for CICADA objects, see ~\cite{CICADA}.\\
...
e/$\gamma$	&	1 * 12	&	$E_t$	&	0..256 GeV	&	0.5	&	9                    \\
	...
	&		&	$\varphi$	&	2$\pi$	&	2$\pi$/144$\sim$0.044	&	8                    \\
	&		&	iso	&		&		&	2                    \\
	&		&	ETT\_pos, ETT\_neg, minimum bias UPC	&		&		&	4                    \\
	&		&	spare	&		&		&	1                    \\
	&		&	TOTAL	&		&		&	32                    \\
% 	&		&		&		&		&	                    \\
\hline
...
object	&	collections $\times$ instances	&	parameter	&	range	&	step	&	bits \\
\hline\hline
AD 	   &	1 * 2	& AD INT	    &	0..255	   &	1	  &	8  \\
	   &	        & AD DEC	    &	0..255	   &	1/256  &	8  \\
HI 	   &	1   	& HI 	        &	0..255	   &	1	  &	8  \\
\hline
\end{tabular}
\label{table:scales_table_4}
\end{table}
...
1 & MU0 eta raw & MU2 eta raw & MU4 eta raw & MU6 eta raw & EG1 & EG7  & JET1 & JET7 & TAU1 & TAU7\\
 & on bits 21:13 & on bits 21:13 & on bits 21:13 & on bits 21:13 & ETT\_pos & MBT0M\_UPC & & & &\\
 & MU1 eta raw & MU3 eta raw & MU5 eta raw & MU7 eta raw & [7:4] & & & & &\\
...
\scalebox{0.8}{
\centering
\begin{tabular}{|c|c|c|c|c|c|c|p{1.5cm}|}\hline
 & \multicolumn{7}{ c| }{link} \\\hline
frame & 10 & 11 & 12 & 13 & 14 & 15 &\makebox[1.5cm][c]{71} \\\hline\hline
0 & ET, & CICADA & ExtCond & ExtCond & ExtCond & ExtCond & 0x3C/0x7C\\
 & ETTEM, & AD INT MSB & [31:0] & [95:64] & [159:128] & [223:192] & (8 bits)\\
 & MBT0HFP & on bits [31:28] & & & & &\\\hline
...
3 & HT$_{miss}$, & CICADA & free & free & free & free &  0\\
 & ASYMHT,& AD DEC LSB & & & & & (32 bits)\\
 & MBT1HFM & on bits [31:28] & & & & &\\\hline
4 & ET$_{miss}^{HF}$ & CICADA & free & free & free & free & counter\\
 & ASYMETHF, & HI MSB & & & & & (12 bits)\\
 & CENT[3:0] & on bits [31:28] & & & & &\\\hline
5 & HT$_{miss}^{HF}$ & CICADA(5) & free & free & free & free &  0\\
 & ASYMHTHF, & HI LSB & & & & & (32 bits)\\
 & CENT[7:4] & on bits [31:28] & & & & &\\\hline
\end{tabular}
}
...
\begin{tabular}{|c|c|}\hline
bit(s) & parameter \\\hline\hline
31..28 & ETT\_pos, ETT\_neg, minimum bias UPC \\
27..27 & spare \\
26..25 & iso \\
24..17 & $\varphi$ \\
16..9 & $\eta$ \\
...
\begin{table}[ht]
\caption{\bf ETT\_pos, ETT\_neg and minimum bias UPC on bits 31:28 of e/$\gamma$ objects}
\vspace{5mm}
\centering
\begin{tabular}{|c|c|}\hline
object & parameter \\\hline\hline
0 & ETT\_pos[3:0] \\
1 & ETT\_pos[7:4] \\
2 & ETT\_pos[11:8] \\
3 & ETT\_neg[3:0] \\
...
11 & free\\\hline
\end{tabular}
\label{table:bits_31_28_eg_object}
\end{table}
...
\begin{table}[ht]
\caption{\bf CICADA data on optical link}
\vspace{5mm}
\centering
\begin{tabular}{|c|l|l|}\hline
frame & 31..28 & 27..0\\\hline\hline
0 & Anomaly Detection Integer MSB & free \\\hline
1 & Anomaly Detection Integer LSB & free \\\hline
2 & Anomaly Detection Decimal MSB & free \\\hline
3 & Anomaly Detection Decimal LSB & free \\\hline
4 & Heavy Ion MSB & free \\\hline
5 & Heavy Ion LSB & free \\\hline
\end{tabular}
\label{table:opt_link_cicada}
\end{table}
...
\begin{table}[ht]
\caption{\bf ZDC data on optical link}
\vspace{5mm}
\centering
\begin{tabular}{|c|c|c|l|}\hline
frame & bit(s)=0 & bit(s) & parameter \\\hline\hline
0 & 31..8 & 7..0 & 0x3C or 0x7C\\
1 & 31..10 & 9..0 & EN\_MINUS (ZDC-)\\
2 & 31..10 & 9..0 & EN\_PLUS (ZDC+)\\
3 & 31..0 & &\\
4 & 31..12 & 11..0 & counter (12bits), not used in uGT\\
5 & 31..0 & &\\\hline

\end{tabular}
\label{table:opt_link_zdc}
\end{table}
...
\bibitem {Darin} 
\href{https://indico.cern.ch/getFile.py/access?contribId=4\&sessionId=0\&resId=0\&materialId=slides\&confId=206223}{\texttt{D. Acosta: "PROPOSAL FOR DATA
FORMATS IN L1 UPGRADE"}}

\bibitem {muon}
\url{http://www.hephy.at/project/cms/trigger/globalMuonTrigger/notes/in04\_006.pdf}

\bibitem {calo}
\href{https://cds.cern.ch/record/1364214/files/in02_069.pdf}{\texttt{CMS NOTE 2002/069: "CMS Level-1 Global Calorimeter Trigger to Global
Trigger and Global Muon Trigger Interfaces"}}

\bibitem {CICADA}
%\url{https://docs.google.com/presentation/d/1Zk2oDbnxUZilnWXC\_HyWYbNJ8F41MiBso4D49bN-js4/edit\#slide=id.g129a5c5a910\_0\_197}
\href{https://github.com/cms-l1-globaltrigger/mp7_ugt_legacy/blob/cicada_link_11_v2/doc/CICADA_Bit_Reference_19_10_23.pdf}{\texttt{Updated description of CICADA structure (CICADA\_Bit\_Reference\_19\_10\_23.pdf)}}

\bibitem {ZDC}
\href{\gitbranch/doc/scales_inputs_2_ugt/ZDC_uhtr_spec_email_24_7_2023.txt}{\texttt{Updated description of ZDC structure (ZDC\_uhtr\_spec\_email\_24\_7\_2023.txt)}}
