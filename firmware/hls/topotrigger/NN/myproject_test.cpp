...
int main(int argc, char **argv)
{
  ...
  if (fin.is_open() && fpr.is_open()) {
    while ( std::getline(fin,iline) && std::getline (fpr,pline) ) {
      ...
      nnet::copy_data<float, input_t, 0, N_INPUT_1_1>(in, onlymu_small_compressed_4folds_hw_bitshiftscaler0_fc1_input);
    ...
    input_t onlymu_small_compressed_4folds_hw_bitshiftscaler0_fc1_input[N_INPUT_1_1];
    nnet::fill_zero<input_t, N_INPUT_1_1>(onlymu_small_compressed_4folds_hw_bitshiftscaler0_fc1_input);
    result_t layer7_out[N_LAYER_5];
