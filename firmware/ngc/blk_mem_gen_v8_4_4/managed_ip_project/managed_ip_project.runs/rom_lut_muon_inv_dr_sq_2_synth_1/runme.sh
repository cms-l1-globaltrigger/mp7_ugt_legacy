...
HD_PWD='/home/bergauer/github/cms-l1-globaltrigger/mp7_ugt_legacy/firmware/ngc/managed_ip_project/managed_ip_project.runs/rom_lut_muon_inv_dr_sq_2_synth_1'
cd "$HD_PWD"
