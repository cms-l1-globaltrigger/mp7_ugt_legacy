...
def run_vsim(vsim, msgmode, ini_file):
    ...
    cmd = [vsim_bin, "-lic_noqueue", "-c", "-msgmode", msgmode, "-modelsimini", ini_file, "-do", "do {filename}; quit -f".format(filename=DO_FILE)]
