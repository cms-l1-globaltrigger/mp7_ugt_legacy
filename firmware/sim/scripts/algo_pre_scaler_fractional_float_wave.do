...
add wave -noupdate /algo_pre_scaler_fractional_tb/dut_1/request_ff
add wave -noupdate /algo_pre_scaler_fractional_tb/dut_1/request_ff_del
add wave -noupdate /algo_pre_scaler_fractional_tb/dut_1/update
...
WaveRestoreCursors {{Cursor 1} {254876896 ps} 0}
...
update
WaveRestoreZoom {0 ps} {627595264 ps}
