...
##TB_DIR
vcom -93 -work work $TB_DIR/cicada_ad_hi_condition_tb.vhd

##Load Design
vsim -t 1ps work.cicada_ad_hi_condition_tb

##Load signals in wave window
view wave
do $TB_DIR/../scripts/cicada_ad_hi_condition_wave.do
