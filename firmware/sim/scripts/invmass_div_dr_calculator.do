...
#Testbench
vcom -93 -work work $TESTBENCH/invmass_div_dr_calculator_tb.vhd

#Load Design
vsim -t 1ps work.invmass_div_dr_calculator_TB 

##Load signals in wave window
view wave
do $TESTBENCH/../scripts/invmass_div_dr_calculator_wave.do
