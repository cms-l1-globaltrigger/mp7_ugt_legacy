...
#Testbench
vcom -93 -work work $TESTBENCH/mass_div_dr_muon_result_tb.vhd

#Load Design
vsim -t 1ps work.mass_div_dr_muon_result_tb

##Load signals in wave window
view wave
do $TESTBENCH/../scripts/mass_div_dr_muon_result_wave.do
