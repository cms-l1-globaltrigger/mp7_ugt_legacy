...
#Testbench
vcom -93 -work work $TESTBENCH/mass_over_dr_muon_tv_algo_12_tb.vhd

#Load Design
vsim -t 1ps work.mass_div_dr_muon_algo_12_tb

##Load signals in wave window
view wave
do $TESTBENCH/../scripts/mass_over_dr_muon_tv_algo_12_wave.do
