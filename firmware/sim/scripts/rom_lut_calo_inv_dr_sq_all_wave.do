...
add wave -noupdate -radix unsigned /rom_lut_calo_inv_dr_sq_all_tb/calo_deta_bin
add wave -noupdate -radix unsigned /rom_lut_calo_inv_dr_sq_all_tb/calo_dphi_bin
add wave -noupdate -radix unsigned /rom_lut_calo_inv_dr_sq_all_tb/dut/deta
add wave -noupdate -radix unsigned /rom_lut_calo_inv_dr_sq_all_tb/dut/dphi
...
update
WaveRestoreZoom {420597978 ps} {421176130 ps}
