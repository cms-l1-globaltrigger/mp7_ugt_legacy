...
#Testbench
vcom -93 -work work $TESTBENCH/rom_lut_muon_inv_dr_sq_all_tb.vhd

#Load Design
vsim -t 1ps work.rom_lut_muon_inv_dr_sq_all_tb

##Load signals in wave window
view wave
do $TESTBENCH/../scripts/rom_lut_muon_inv_dr_sq_all_wave.do
