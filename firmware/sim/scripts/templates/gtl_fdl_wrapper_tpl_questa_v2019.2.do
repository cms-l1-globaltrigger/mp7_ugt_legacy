...
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/charge_comp.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/phi_windows_comp.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/eta_comp_signed.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/eta_windows_comp.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/calo_comparators.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/esums_comparators.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/muon_comparators.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/matrix_calo_cond.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/matrix_calo_cond_orm.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/matrix_muon_cond.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/matrix_muon_charge_corr.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/matrix_corr_cond.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/deta_calc.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/dphi_calc.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/deta_cosh_deta_luts.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/dphi_cos_dphi_luts.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/dr_calc.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/mass_calc.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/sum_mass_calc.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/sum_mass.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/mass_over_dr_calc.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/tbpt_calc.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/calo_obj_cuts.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/muon_obj_cuts.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/charge_correlation_comp.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/correlation_cut_comp.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/correlation_cuts_wrapper.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/orm_cuts.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/common/esums_4_corr_cond.vhd
#
...
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/deta_dphi_calculations.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/correlation_cuts_calculation.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/comb_conditions.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/esums_conditions.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/min_bias_hf_conditions.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/towercount_condition.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl/correlation_conditions.vhd
#
...
vcom -93 -work work $HDL_DIR/gt_mp7_core/fdl/common/algo_rate_counter.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/fdl/common/algo_post_dead_time_counter.vhd
vcom -93 -work work $HDL_DIR/gt_mp7_core/fdl/common/algo_slice.vhd
...
vcom -93 -work work $HDL_DIR/gt_mp7_core/gtl_fdl_wrapper.vhd
