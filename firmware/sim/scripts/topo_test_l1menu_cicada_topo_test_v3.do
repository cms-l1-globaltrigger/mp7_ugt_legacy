...
set TEST_DIR ./topo_test/l1menu_cicada_topo_test_v3
set TEST_DIR_MOD ./topo_test/l1menu_cicada_topo_test_v3/module_1
...
vcom -93 -work work $TEST_DIR_MOD/gtl_module_adt.vhd
...
##TB_DIR
vcom -93 -work work $TB_DIR/topo_test_l1menu_cicada_topo_test_v3_tb.vhd

##Load Design
vsim -t 1ps work.topo_test_l1menu_cicada_topo_test_v3_tb

##Load signals in wave window
view wave
do $TB_DIR/../scripts/topo_test_l1menu_cicada_topo_test_v3_wave.do
