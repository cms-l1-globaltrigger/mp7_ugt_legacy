...
vcom -93 -work work $MTI/gt_mp7_core/gtl_fdl_wrapper/gtl/b_tagging_condition.vhd

#Testbench
vcom -93 -work work $TESTBENCH/b_tagging_condition_tb.vhd

#Load Design
vsim -t 1ps work.b_tagging_condition_tb 

##Load signals in wave window
view wave
do $TESTBENCH/../scripts/b_tagging_condition_test_dr_wave.do
