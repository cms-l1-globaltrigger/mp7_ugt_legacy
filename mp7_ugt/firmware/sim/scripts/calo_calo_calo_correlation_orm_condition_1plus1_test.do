...
#Testbench
vcom -93 -work work $TESTBENCH/calo_calo_calo_correlation_orm_condition_1plus1_test_tb.vhd

#Load Design
vsim -t 1ps work.calo_calo_calo_correlation_orm_condition_1plus1_test_tb 

##Load signals in wave window
view wave
do $TESTBENCH/../scripts/calo_calo_calo_correlation_orm_condition_1plus1_test_wave.do
