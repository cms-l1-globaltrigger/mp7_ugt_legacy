...
vcom -93 -work work $MTI/gt_mp7_core/gtl_fdl_wrapper/gtl/gtl_pkg_sim_inv_mass.vhd
...
vcom -93 -work work $MTI/gt_mp7_core/gtl_fdl_wrapper/gtl/calo_calo_correlation_condition.vhd

#Testbench
vcom -93 -work work $TESTBENCH/calo_calo_correlation_condition_inv_mass_tb.vhd

#Load Design
vsim -t 1ps work.calo_calo_correlation_condition_inv_mass_tb 

##Load signals in wave window
view wave
do $TESTBENCH/../scripts/calo_calo_correlation_condition_test_inv_mass_wave.do
