...
vcom -93 -work work $MTI/gt_mp7_core/gtl_fdl_wrapper/gtl/calo_calo_correlation_condition_v2.vhd

#Testbench
vcom -93 -work work $TESTBENCH/calo_calo_correlation_condition_v2_mass_cuts_same_obj_bx_tb.vhd

#Load Design
vsim -t 1ps work.calo_calo_correlation_condition_v2_mass_cuts_same_obj_bx_tb

##Load signals in wave window
view wave
do $TESTBENCH/../scripts/calo_calo_correlation_condition_v2_mass_cuts_same_obj_bx_test_wave.do
