...
#Testbench
vcom -93 -work work $TESTBENCH/calo_calo_correlation_condition_v3_mass_cuts_same_obj_bx_tb.vhd

#Load Design
vsim -t 1ps work.calo_calo_correlation_condition_v3_mass_cuts_same_obj_bx_tb

##Load signals in wave window
view wave
do $TESTBENCH/../scripts/calo_calo_correlation_condition_v3_mass_cuts_same_obj_bx_test_wave.do
