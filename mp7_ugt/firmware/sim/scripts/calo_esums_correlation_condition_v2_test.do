...
vcom -93 -work work $MTI/gt_mp7_core/gtl_fdl_wrapper/gtl/calo_esums_correlation_condition_v2.vhd

#Testbench
vcom -93 -work work $TESTBENCH/calo_esums_correlation_condition_v2_tb.vhd

#Load Design
vsim -t 1ps work.calo_esums_correlation_condition_v2_tb

##Load signals in wave window
view wave
do $TESTBENCH/../scripts/calo_esums_correlation_condition_v2_test_wave.do
