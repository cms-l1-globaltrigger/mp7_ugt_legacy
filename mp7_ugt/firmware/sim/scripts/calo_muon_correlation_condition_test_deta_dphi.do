...
##--------------------------------------------------------------------------------
##---Description: 
##-- $HeadURL: svn://heros.hephy.at/GlobalTriggerUpgrade/firmware/gt_mp7/branches/hb_algo_2_buffer/sim/scripts/calo_muon_correlation_condition_test_deta_dphi.do $
...
#Load Design
vsim -t 1ps work.calo_muon_correlation_condition_deta_dphi_tb 

##Load signals in wave window
view wave
do $TESTBENCH/../scripts/calo_muon_correlation_condition_test_deta_dphi_wave.do
