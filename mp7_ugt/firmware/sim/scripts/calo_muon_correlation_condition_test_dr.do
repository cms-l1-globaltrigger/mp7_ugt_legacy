...
#Testbench
vcom -93 -work work $TESTBENCH/calo_muon_correlation_condition_dr_tb.vhd

#Load Design
vsim -t 1ps work.calo_muon_correlation_condition_dr_tb 

##Load signals in wave window
view wave
do $TESTBENCH/../scripts/calo_muon_correlation_condition_test_dr_wave.do
