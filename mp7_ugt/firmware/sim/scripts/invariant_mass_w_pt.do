...
vcom -93 -work work $GT_SRC/gt_mp7_core/gtl_fdl_wrapper/gtl/invariant_mass_w_pt.vhd

#Testbench
vcom -93 -work work $TESTBENCH/invariant_mass_w_pt_tb.vhd

#Load Design
vsim -t 1ps work.invariant_mass_w_pt_TB 

##Load signals in wave window
view wave
do $TESTBENCH/../scripts/invariant_mass_w_pt_wave.do
