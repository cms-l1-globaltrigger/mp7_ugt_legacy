...
vcom -93 -work work $GT_SRC/gt_mp7_core/gtl_fdl_wrapper/gtl/mass_calculator_v2.vhd

#Testbench
vcom -93 -work work $TESTBENCH/mass_calculator_v2_tb.vhd

#Load Design
vsim -t 1ps work.mass_calculator_v2_TB 

##Load signals in wave window
view wave
do $TESTBENCH/../scripts/mass_calculator_v2_wave.do
